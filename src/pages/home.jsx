    ...
    <div>
        ...
        <div class="how_container">
          <div class="box">
            ...
            <div class="detail-box">
              <h5>
                {" "}
                <a
                  href="https://www.cointree.com/learn/crypto-investor-types/"
                  target="_blank"
                >
                  {" "}
              ...
              <p>
                Both traders and investors can participate in financial markets
                to generate profits for themselves & their employers/clients.
              </p>
            </div>
          </div>
          <div class="box">
            ...
            <div class="detail-box">
              <h5>Exchanges</h5>
              <p>
                Crypto exchanges play a crucial role in the cryptocurrency
                ecosystem, enabling trading and exchange of digital assets.
              </p>
            </div>
          </div>
          <div class="box">
            ...
            <div class="detail-box">
              <h5>
                <a
                  href="https://www.investopedia.com/tech/how-does-bitcoin-mining-work/"
                  target="blank"
                >
                  Miners
                </a>
              ...
              <p>
                Crypto miners are individuals or organizations that use powerful
                computing equipment to validate and secure transactions on a
                blockchain network.
              </p>
            </div>
          </div>
          <div class="box">
            ...
            <div class="detail-box">
              <h5>Payments</h5>
              <p>
                Cryptocurrencies are digital or virtual currencies that operate
                on distributed ledger technology called blockchain and use
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="detail-box">
                ...
                <p>
                  Our application is available on Google playstore and Apple
                  appstore as well, providing a secure and trusted platform for
                  iOS & android users to discover, download, and install our
                  app.
                </p>
      ...
      <section class="auto_section layout_padding">
        <div class="container">
          ...
          <div class="box">
            <div class="img-box">
              <img src="images/auto-img.png" alt=""></img>
            </div>
            <div class="detail-box">
              <p>
                With the help of cryptop you can fulfill your dream of buying
                that car by investing in crypto Currency. Its time to put your
                knowledge of the market in to use, let your money make you
                money. Cryptop is very easy to use and with the help of our
                customer friendly service, we are available 24/7 for you guys.
              </p>
              <div class="btn-box">
          ...
          <div class="box">
            <div class="b-1">
              <div class="client_id">
                ...
                <div class="name">
                  <h5>John Doe</h5>
                  <h6> Realtor and part time Trader</h6>
                </div>
              </div>
            </div>
            <div class="client_detail">
              <p>
                I have used many different platforms for trading cryptocurrency
                and no other app is as easy and smooth to use like the cryptop.
                I am using this app since a long time now, and I am enjoying it.
              </p>
            </div>
          </div>
          <div class="box">
            <div class="client_id">
              ...
              <div class="name">
                <h5>Richard Roe</h5>
                <h6> Tech geek in Bengaluru</h6>
              </div>
            </div>
            <div class="client_detail">
              <p>
                For investing in crypto currencies I am using cryptop
                application as it is not just easy to use and access, but also
                provides safe digital transactions.
              </p>
            </div>
          </div>
          <div class="btn-box">
